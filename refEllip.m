%  [a,b,f,ec,n] = REFELLIP(re)
%
%  DESCRIPTION: Parameters database with 19 of the most broadly used
%  Reference Ellipsoids. A Reference Ellipsoid is a matemathical model of
%  the earth that, along with its position relative to the center of the
%  earth, establish a Geographic Coordinate System or 'Datum'. Three
%  parameters define the ellipsoid: radius at the equator, radius at the
%  poles and flattening. The same ellipsoid can be used for different
%  Datums.
%
%  INPUT ARGUMENTS
%  - re: character string specifying the Reference Ellipsoid. 25 types 
...
%
%    NOTE: The most accurate and widely used globally-applicable 
%    model for the earth ellipsoid is WGS-84, used in this script. 
%    Other ellipsoids offering a better fit to the local geoid 
%    include Airy (1830) in the UK, International 1924 in much of 
%    Europe, Clarke (1880) in Africa, GRS-67 in South America, and 
%    many others. America (NAD83) and Australia (GDA) use GRS-80, 
%    functionally equivalent to the WGS-84 ellipsoid.
%
%  OUTPUT ARGUMENTS
...
%  VERSION 1.3: 01 Jul 2021 Updated help
%  VERSION 1.2: 12 Jun 2014 Added third flattening parameter as output (n)
%  VERSION 1.1: 05 Jun 2014 Added new Ref. Ellipsoids and related Datums
%  VERSION 1.0: 03 Jun 2014
%  Guillermo Jimenez Arranz
%  email: gjarranz@gmail.com

function [a,b,f,ec,n] = refEllip(re)
